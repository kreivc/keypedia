                        ...
                        <div class="d-flex align-self-start">
                            ...
                            <div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                            name="name" value="{{ old('name') ?? $keyboard->name }}" required autocomplete="name" autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="price" type="number" class="form-control" name="price" required
                                            autocomplete="price" min="1" value="{{ old('price') ?? $keyboard->price }}">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="description" rows="6" type="text" class="form-control" name="description"
                                            required autocomplete="description">{{ old('description') ?? $keyboard->description }}</textarea>
                                    </div>
